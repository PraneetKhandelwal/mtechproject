# Contains code to plot the anomalies for each center on the entire scale from STARTDATE to ENDDATE
...
# Function to get the labels from semilabelsfile
...
# Function which loads the correct predictions for the step 1 from the correctpredictions.csv file
...
def train_test_function(align_m,align_d,align_l,align_b,data_m,data_d,data_l,data_b):
  ...
  plt.title('Bangalore Anomalies Step 1 Result')
  plt.xlabel('Time')
