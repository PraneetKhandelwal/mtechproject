# Code to generate Retail price or Mandi price signatures for hoarding and weather anomalies
# Basically takes average of retail price for the 43 day window for all the same kind of anomalies
...
# Code for adjusting anomaly window
