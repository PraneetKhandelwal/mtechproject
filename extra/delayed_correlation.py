# This code performs delayed correlation between mandi arrivals, prices and retail prices for different seasons.
# The new code that fulfils the purpose is in relationmandis.py
# Make sure that this file is put in the same folder as the 'data' folder to run properly.
