...
mandipriceseriesdelhi = mandipriceseriesdelhi.rolling(window=15,center=True).mean()

plt.plot(mandipriceseriesdelhi,color='b',label='Interpolated Mandi Price')
plt.title('Azadpur Mandi Price')
plt.xlabel('Time')
plt.ylabel('Mandi Price (Rs per quintal)')
plt.show()
